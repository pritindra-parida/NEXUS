    ...
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <!-- Uncomment below if you prefer to use a text logo -->
         <!-- <a href="index.html"><img src="img/full-logo-white.png"></a>         -->
    ...
    <section id="login-page" class="wow fadeIn">
      <div class="container">
        <div class="section-header">
          <h2>Sign Up</h2>
          <p>Enter the required details to create an account</p>
        </div>
      ...
      <div class="container-fluid h-custom">
        <div class="row d-flex justify-content-center align-items-center h-100">
          ...
          <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
            ...
            <form action="/NEXUS_test/backend/sign_up.php" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
              ...
              <div class="text-center text-lg-start mt-4 pt-2">
                <button type="submit" class="btn btn-primary btn-lg"
                  style="padding-left: 2.5rem; padding-right: 2.5rem; width: 100%;">Sign Up</button>
  ...
  <script type="text/javascript">
    ...
    var checkEmail = function() 
    {
      if(document.getElementById('email').value.match(mailformat) ){ 
        ...
        document.getElementById('message1').innerHTML = 'Enter a valid Email'; 
      }
    }
    ...
    {
      if (document.getElementById('password').value ==
        document.getElementById('confirm_password').value  || document.getElementById('email').value.match(mailformat)) {
      return true; 
      } 
      else{
