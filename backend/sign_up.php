...
{ 
	...
	if($email !=''|| $password !='')
	{
		...
		$create_event_list_table = "CREATE TABLE `event_list` (`event_id` INT(10) NOT NULL AUTO_INCREMENT , `event_name` VARCHAR(250) NOT NULL , `event_date` DATE NOT NULL , `event_venue` VARCHAR(250) NOT NULL , `participants_number` INT(250) NOT NULL , PRIMARY KEY (`event_id`)) ENGINE = InnoDB;";
